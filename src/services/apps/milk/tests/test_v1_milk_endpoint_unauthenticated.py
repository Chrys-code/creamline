...
def test_milk_v1_detail_endpoint_unauthenticated_returns_403(
    api_client, milk
):
...
def test_milk_v1_create_endpoint_unauthenticated_returns_403(
    api_client, milk_payload
):
    url = reverse("api:v1:milk-list")
...
def test_milk_v1_delete_endpoint_unauthenticated_returns_403(
    api_client, milk
):
    url = reverse("api:v1:milk-detail", args=[milk.uuid])
